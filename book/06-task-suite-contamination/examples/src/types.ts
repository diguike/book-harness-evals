// harness-lab 评测层与具体 harness 的唯一耦合点，字段即第 5 章 adapter 接口的 canonical 定义。
// 本章只用到 EvalTask / TaskOracle，其余接口一并列出以保持类型完整，可独立运行。
...
/** OTAR 因果 DAG 节点：Observation / Thought / Action / Result（第 8 章详解） */
